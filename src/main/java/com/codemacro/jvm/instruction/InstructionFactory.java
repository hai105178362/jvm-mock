...
public class InstructionFactory {
  ...
  private static void initialize() {
    ...
    Function<Boolean, Instruction> createInvoke = (isStatic) -> {
      return (codes, frame) -> {
        ...
        if (symbol != null) {
          System.out.println("createInvokeisStatic resolveMethodByRef " + symbol.method.getDeclaration());
  ...
  private static void register(int op, Instruction inst) {
    instructions.put(op, (code, frame) -> {
      ...
      System.out.println(String.format("inst exec 0x%02x", op) + " op name: " + getOpTitle(op));
      inst.exec(code, frame);
    });
  }

  private static String getOpTitle(int op) {
    HashMap<Integer, String> cacheops = new HashMap<>();
    cacheops.put(Opcode.op_iconst_m1, "op_iconst_m1");
    cacheops.put(Opcode.op_iconst_0, "op_iconst_0 ");
    cacheops.put(Opcode.op_iconst_1, "op_iconst_1 ");
    cacheops.put(Opcode.op_iconst_2, "op_iconst_2 ");
    cacheops.put(Opcode.op_iconst_3, "op_iconst_3 ");
    cacheops.put(Opcode.op_iconst_4, "op_iconst_4 ");
    cacheops.put(Opcode.op_iconst_5, "op_iconst_5 ");
    cacheops.put(Opcode.op_istore_0, "op_istore_0 ");
    cacheops.put(Opcode.op_istore_1, "op_istore_1 ");
    cacheops.put(Opcode.op_istore_2, "op_istore_2 ");
    cacheops.put(Opcode.op_istore_3, "op_istore_3 ");
    cacheops.put(Opcode.op_astore_0, "op_astore_0");
    cacheops.put(Opcode.op_astore_1, "op_astore_1");
    cacheops.put(Opcode.op_astore_2, "op_astore_2");
    cacheops.put(Opcode.op_astore_3, "op_astore_3");
    cacheops.put(Opcode.op_iload_0, "op_iload_0");
    cacheops.put(Opcode.op_iload_1, "op_iload_1");
    cacheops.put(Opcode.op_iload_2, "op_iload_2");
    cacheops.put(Opcode.op_iload_3, "op_iload_3");
    cacheops.put(Opcode.op_aload_0, "op_aload_0");
    cacheops.put(Opcode.op_aload_1, "op_aload_1");
    cacheops.put(Opcode.op_aload_2, "op_aload_2");
    cacheops.put(Opcode.op_aload_3, "op_aload_3");
    cacheops.put(Opcode.op_ldc, "op_ldc");
    cacheops.put(Opcode.op_bipush, "op_bipush                          ");
    cacheops.put(Opcode.op_sipush, "op_sipush                          ");
    cacheops.put(Opcode.op_dup, "op_dup                                ");
    cacheops.put(Opcode.op_pop, "op_pop                                ");
    cacheops.put(Opcode.op_iinc, "op_iinc                              ");
    cacheops.put(Opcode.op_iadd, "Opcode.op_iadd                       ");
    cacheops.put(Opcode.op_isub, "Opcode.op_isub                       ");
    cacheops.put(Opcode.op_imul, "Opcode.op_imul                       ");
    cacheops.put(Opcode.op_return, "Opcode.op_return                   ");
    cacheops.put(Opcode.op_ireturn, "Opcode.op_ireturn                 ");
    cacheops.put(Opcode.op_areturn, "Opcode.op_areturn                 ");
    cacheops.put(Opcode.op_invokestatic, "Opcode.op_invokestatic       ");
    cacheops.put(Opcode.op_invokevirtual, "Opcode.op_invokevirtual     ");
    cacheops.put(Opcode.op_invokespecial, "Opcode.op_invokespecial     ");
    cacheops.put(Opcode.op_if_icmpne, "Opcode.op_if_icmpne             ");
    cacheops.put(Opcode.op_if_icmpge, "Opcode.op_if_icmpge             ");
    cacheops.put(Opcode.op_ifgt, "Opcode.op_ifgt                       ");
    cacheops.put(Opcode.op_ifle, "Opcode.op_ifle                       ");
    cacheops.put(Opcode.op_ifne, "Opcode.op_ifne                       ");
    cacheops.put(Opcode.op_goto, "Opcode.op_goto                       ");
    cacheops.put(Opcode.op_new, "Opcode.op_new                         ");
    cacheops.put(Opcode.op_putfield, "Opcode.op_putfield               ");
    cacheops.put(Opcode.op_getfield, "Opcode.op_getfield               ");
    cacheops.put(Opcode.op_aconst_null, "Opcode.op_aconst_null         ");
    cacheops.put(Opcode.op_checkcast, "Opcode.op_checkcast             ");
    cacheops.put(Opcode.op_athrow, "Opcode.op_athrow                   ");
    return cacheops.get(op);
  }
